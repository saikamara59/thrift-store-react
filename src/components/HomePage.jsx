      ...
      <div className="flex flex-col md:flex-row justify-between p-4 md:p-9 flex-grow bg-customYellow bg-opacity-50">
        <div className="w-full md:w-1/2 p-4 md:p-6 bg-opacity-20 rounded-lg shadow-inner mb-4 md:mb-0">
          ...
          <p className="text-left mt-4 md:mt-7 font-irish font-semibold text-xl md:text-md">
            ...
            to reducing waste in the fashion industry. We believe that style
            shouldn't come at the expense of the planet, and that's why we're
            dedicated to offering a curated selection of vintage, pre-loved, and
            rare fashion pieces. We get rare timeless pieces from past decades
            that tell a story.
          </p>
        </div>
